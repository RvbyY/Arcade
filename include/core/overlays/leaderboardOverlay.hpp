...
namespace Arcade {
    ...
    class LeaderboardOverlay : public IGame {
        public:
            explicit LeaderboardOverlay(Core& core);
            ~LeaderboardOverlay() noexcept override = default;
            ...
            std::string_view gameTitle() const noexcept override { return "Leaderboard Overlay - BAM"; }
